...
//replace with your local network ssid and password
...
void setup() {
  //we initialize serial communication at 115200 bps
  Serial.begin(115200);
  ...
  //we print local IP Address of ESP32-CAM development board
  Serial.print("IP Address: http://");
  Serial.println(WiFi.localIP());

  //we turn-off the 'brownout detector'
  ...
  //we set the route for root / web page
